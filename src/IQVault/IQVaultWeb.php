...
class IQVaultWeb extends \SoapClient
{
    ...
    public function __construct(array $options = array(), $wsdl = null)
    {
        ...
        if (!$wsdl) {
            $wsdl = 'https://iqweb2.brettrobinsondns.com/iqvaultwebaccess/iqvaultweb.asmx?wsdl';
        }
    ...
    {
        return $this->__soapCall('WriteCCWithProtobase', array($parameters));
    }
    ...
    {
        return $this->__soapCall('ProcessCard', array($parameters));
    }
    ...
    {
        return $this->__soapCall('IsCCFeeActive', array($parameters));
    }
    ...
    {
        return $this->__soapCall('WriteCCInterface', array($parameters));
    }
    ...
    {
        return $this->__soapCall('GetCreditCardType', array($parameters));
    }
    ...
    {
        return $this->__soapCall('GetTokenForSession', array($parameters));
    }
    ...
    {
        return $this->__soapCall('TestVaultUser', array($parameters));
    }
    ...
    {
        return $this->__soapCall('WriteCC', array($parameters));
    }
}
